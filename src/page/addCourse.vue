                ...
                <el-form :model="courseInfo" :rules="rules" ref="courseInfo" label-width="110px" class="demo-courseInfo">
                    ...
                    <el-form-item label="课程时间"   v-if="courseInfo.exactCourses">
                        <el-col :span="11" v-if="courseInfo.exactCourses">
                            <el-date-picker type="date" placeholder="选择日期" prop="exactCourses[0].openingTime"  v-model="courseInfo.exactCourses[0].openingTime" style="width: 100%;"></el-date-picker>
                        </el-col>
                    </el-form-item>
                    ...
                    <el-form-item class="button_submit" style="text-align:center;">
                        ...
                        <el-button type="primary" @click="submitForm('courseInfo')" style="width: 150px;margin-top: 20px">提交课程</el-button>
                    </el-form-item>
                </el-form>
            </el-col>
        </el-row>
